...
# For evaluating the time and memory a model takes for prediction
import time
import psutil
import os
...
while True:
    ...
    for rect in rects:
        ...
        # Converting to megabytes for a readable value
        memory_usage_mb = memory_usage / (1024 ** 2)

        print("")
        print("Inference Time: {:.4f} seconds".format(inference_time))
        print("Total Memory Usage: {:.2f} MB".format(memory_usage_mb))
        print("")
